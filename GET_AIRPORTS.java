...
public class GET_AIRPORTS {
     ...
     * @return ArrayList<String> - an Array List containing airports for the given
     *         city.
     */
    public static ArrayList<String> getAirports(String city, String country) {
        ...
        if (airportCodes.size() == 0) {
            System.out.println("Ooops, one of your cities has no available airport. We are now " +
                    "exiting the program");
            System.exit(0);
