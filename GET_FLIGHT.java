...
public class GET_FLIGHT {
    ...
    static class FlightNode {
         ...
         * 
         * @return ArrayList<ArrayList<String>> an ArrayList containing interconnecting flights leading up to the current flight
         */
     ...
     * 
     * @param departureAirports - an ArrayList of Strings containing departure airports
     * @param arrivalAirports - an ArrayList of Strings containing arrival airports
     */
     ...
     * getFlightPath
     * 
     * @param startAirport - a string representing an airport from which the journey is started
     * @param stopAirports - an ArrayList of strings representing the possible destination airports
     * @return ArrayList<ArrayList<String>> - a two dimensional ArrayList of strings containing a flight path
     */
